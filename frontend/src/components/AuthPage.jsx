...
import { url_base, auth_url } from '../config/url_config';
import { useState } from 'react';


const pass_svg = {
    hidden: <><path d="M13 10a3 3 0 11-6 0 3 3 0 016 0zm-1.5 0a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"></path><path d="M19 10c0 3.5-5 6-9 6s-9-2.5-9-6 5-6 9-6 9 2.5 9 6zm-1.5 0c0 .983-.72 2.084-2.279 3.03-1.516.92-3.497 1.47-5.221 1.47-1.725 0-3.705-.55-5.222-1.47C3.22 12.084 2.5 10.983 2.5 10c0-.983.72-2.084 2.278-3.03C6.295 6.05 8.275 5.5 10 5.5c1.724 0 3.705.55 5.221 1.47 1.56.946 2.279 2.047 2.279 3.03z"></path></>,
    ...
    return (
        <div className="background">
            <form onSubmit={onSubmit} className="form-card">
                ...
                <div className="form-subtitle">Enter your username and password to log in</div>

                <div className="auth">
                    <div className='auth-wrapper'>
                        <input className="auth-input" name="username" placeholder='Enter username' />
